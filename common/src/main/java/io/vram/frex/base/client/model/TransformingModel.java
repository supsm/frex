...
public class TransformingModel extends BaseModel {
	...
	public static BiFunction<Map<ResourceLocation, BlockModel>, Map<ResourceLocation, List<BlockStateModelLoader.LoadedJson>>, ModelProvider<ResourceLocation>> createProvider(Consumer<Builder> setupFunc, Supplier<BlockItemModel> modelSupplier, QuadTransform transform) {
